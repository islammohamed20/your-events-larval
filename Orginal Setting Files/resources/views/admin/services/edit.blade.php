            ...
            <div class="card-body">
                <ul class="list-unstyled mb-0">
                    <li class="mb-2">
                        ...
                        <small class="text-muted">{{ $service->created_at->format('d/m/Y H:i') }}</small>
                    </li>
                    <li class="mb-2">
                    ...
                    <li class="mb-2">
                        ...
                        <span class="badge bg-secondary">{{ $service->type ?? 'غير محدد' }}</span>
                    </li>
                    <li class="mb-0">
        ...
        <div class="card mt-3">
            ...
            <div class="card-body">
                <div class="text-center">
                    <h4 class="text-info">{{ $service->bookings_count ?? 0 }}</h4>
