...
@section('title', 'حجز موعد - Your Events')
            ...
            <div class="col-lg-8">
                ...
                <div class="text-center mt-5" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="d-flex justify-content-center gap-4 flex-wrap">
                        <a href="tel:+966501234567" class="btn btn-outline-primary">
                            <i class="fas fa-phone me-2"></i>+966 50 123 4567
                        </a>
                        <a href="mailto:info@yourevents.com" class="btn btn-outline-primary">
                            <i class="fas fa-envelope me-2"></i>info@yourevents.com
                        </a>
