...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (Schema::hasTable('galleries')) {
            ...
            try { DB::statement('CREATE INDEX galleries_sort_order_index ON galleries (sort_order)'); } catch (\Throwable $e) {}
            try { DB::statement('CREATE INDEX galleries_category_index ON galleries (category)'); } catch (\Throwable $e) {}
