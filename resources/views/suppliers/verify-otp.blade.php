                        ...
                        <form method="POST" action="{{ route('suppliers.verify-otp.post') }}" id="otpForm" data-resend-url="{{ \Illuminate\Support\Facades\Route::has('suppliers.resend-otp') ? route('suppliers.resend-otp') : route('otp.resend') }}">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="otp-input-wrapper d-flex justify-content-center gap-2 mb-3">
                                    <input type="text" inputmode="numeric" pattern="[0-9]*" autocomplete="one-time-code" class="otp-digit form-control form-control-lg text-center" maxlength="1" data-index="0">
                                    <input type="text" inputmode="numeric" pattern="[0-9]*" class="otp-digit form-control form-control-lg text-center" maxlength="1" data-index="1">
                                    <input type="text" inputmode="numeric" pattern="[0-9]*" class="otp-digit form-control form-control-lg text-center" maxlength="1" data-index="2">
                                    <input type="text" inputmode="numeric" pattern="[0-9]*" class="otp-digit form-control form-control-lg text-center" maxlength="1" data-index="3">
                                    <input type="text" inputmode="numeric" pattern="[0-9]*" class="otp-digit form-control form-control-lg text-center" maxlength="1" data-index="4">
                                    <input type="text" inputmode="numeric" pattern="[0-9]*" class="otp-digit form-control form-control-lg text-center" maxlength="1" data-index="5">
                                </div>
